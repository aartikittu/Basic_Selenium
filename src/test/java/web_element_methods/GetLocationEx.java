...
public class GetLocationEx {
	...
	public static void main(String[] args) 
	{
		...
		Point loc=add_to_cart.getLocation();
		System.out.println("Location on X  axis "+loc.getX());
		System.out.println("Location on Y axis "+loc.getY());
	}
